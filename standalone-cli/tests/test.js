...
const platformMap = {
  darwin: `./dist/segmentdesign-macos-${process.arch}`,
  linux: `./dist/segmentdesign-linux-${process.arch}`,
  win32: `.\\dist\\segmentdesign-windows-${process.arch}`,
}
...
async function inIsolatedContext(fn) {
  ...
  let dest = `${os.tmpdir()}/segmentdesign-cli`
