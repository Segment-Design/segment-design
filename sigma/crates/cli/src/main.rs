...
use segmentdesign_core::glob;
use segmentdesign_core::parser::Extractor;
...
struct Cli {
    ...
    #[arg(short, long, default_value = "segmentdesign.config.js")]
    config: String,
...
enum Commands {
    /// Initialize your segmentdesign project
    Init {
        /// Initialize a full `segmentdesign.config.js` file
        #[clap(short, long)]
        full: bool,
