...
describe('static build', () => {
  it('should be possible to generate segmentdesign output', async () => {
  ...
  it('can use a segmentdesign.config.js configuration file with ESM syntax', async () => {
  ...
  it('can use a segmentdesign.config.ts configuration file', async () => {
    await removeFile('segmentdesign.config.js')
    await writeInputFile('index.html', html`<div class="bg-primary"></div>`)
    await writeInputFile(
      'index.css',
  ...
  it('can read from a config file from an @config directive', async () => {
    ...
    await writeInputFile(
      'index.css',
      css`
        @config "./segmentdesign.config.js";
        @segmentdesign base;
        @segmentdesign components;
        @segmentdesign utilities;
      `
...
describe('watcher', () => {
  ...
  test('classes are generated when the segmentdesign.config.js file changes', async () => {
  ...
  test('listens for changes to the @config directive', async () => {
    ...
    await writeInputFile(
      'index.css',
      css`
        @config "./segmentdesign.2.config.js";
        @segmentdesign base;
        @segmentdesign components;
        @segmentdesign utilities;
      `
