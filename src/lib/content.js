 ...
 *
 * Copyright (c) Segment Design
 * Copyright (c) @stuffincode - Riaz Ahamed <riazahamed.io>
 *
 ...
 *
 * @param {*} context
 * @param {import('segmentdesign').Config} segmentdesignConfig
 * @returns {ContentPath[]}
 */
export function parseCandidateFiles(context, segmentdesignConfig) {
  let files = segmentdesignConfig.content.files
...
function resolveRelativePaths(context, contentPaths) {
  ...
  if (context.userConfigPath && context.segmentdesignConfig.content.relative) {
...
export function resolvedChangedContent(context, candidateFiles, fileModifiedMap) {
  let changedContent = context.segmentdesignConfig.content.files
