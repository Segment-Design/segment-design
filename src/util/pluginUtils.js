...
export function asColor(modifier, options = {}, { segmentdesignConfig = {} } = {}) {
  ...
  if (alpha !== undefined) {
    ...
    if (segmentdesignConfig.theme?.opacity?.[alpha] === undefined) {
      return undefined
    }

    return withAlphaValue(normalizedColor, segmentdesignConfig.theme.opacity[alpha])
  }
...
export function coerceValue(types, modifier, options, segmentdesignConfig) {
  ...
  let matches = getMatchingTypes(types, modifier, options, segmentdesignConfig)
 ...
 */
export function* getMatchingTypes(types, rawModifier, options, segmentdesignConfig) {
