...
crosscheck(({ stable, sigma }) => {
  describe('modern', () => {
    sigma.test.todo('extract.DEFAULT')
    ...
    sigma.test.todo('extract.{extension}')
    ...
    sigma.test.todo('extract function')
    ...
    sigma.test.todo('raw content with extension')
  ...
  describe('legacy', () => {
    sigma.test.todo('defaultExtractor')
    ...
    sigma.test.todo('extractors array')
