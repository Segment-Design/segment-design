...
crosscheck(({ stable, sigma }) => {
  ...
  sigma.test.todo('negative values: marker before prefix')
  ...
  sigma.test.todo('negative values: marker after prefix')
  ...
  sigma.test.todo('negative values: marker before prefix and arbitrary value')
  ...
  sigma.test.todo('negative values: marker after prefix and arbitrary value')
  ...
  sigma.test.todo('negative values: no marker and arbitrary value')
  ...
  sigma.test.todo('negative values: variant versions')
  ...
  sigma.test.todo('negative values: prefix and apply')
  ...
  sigma.test.todo('negative values: prefix in the safelist')
  ...
  sigma.test.todo('prefix with negative values and variants in the safelist')
  ...
  sigma.test.todo('prefix does not detect and generate unnecessary classes')
  ...
  sigma.test.todo('supports prefixed utilities using arbitrary values')
  ...
  sigma.test.todo('supports non-word prefixes (1)')
  ...
  sigma.test.todo('supports non-word prefixes (2)')
