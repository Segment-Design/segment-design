...
crosscheck(({ stable, sigma }) => {
  sigma.test.todo('apply generates source maps')
  stable.test('apply generates source maps', async () => {
    ...
    // All CSS generated by segmentdesign should be annotated with source maps
  ...
  sigma.test.todo('preflight + base have source maps')
  ...
  sigma.test.todo('utilities have source maps')
  ...
  sigma.test.todo('components have source maps')
  ...
  sigma.test.todo('source maps for layer rules are not rewritten to point to @segmentdesign directives')
  stable.test(
    'source maps for layer rules are not rewritten to point to @segmentdesign directives',
    async () => {
      let config = {
      ...
      // to point to the @segmentdesign directive but instead points to the original
