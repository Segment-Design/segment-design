...
crosscheck(() => {
  ...
  test('No defaults without @segmentdesign base', () => {
    let config = {
      experimental: { optimizeUniversalDefaults: true },
    ...
    // We require you to use @segmentdesign base to inject the defaults
    let input = css`
  ...
  test('no defaults and apply without @segmentdesign base', () => {
    let config = {
      experimental: { optimizeUniversalDefaults: true },
